...
<div class="main_body">
    ...
    <div class="rg_content">
        <form action="controller/RegisterServlet" method="post">
            <p style="display: inline">帐号：<input type="text" class="rg_account"/></p>
            <p style="color: #ff0c46;display: inline" >此帐号已注册</p>
            <p>密码：<input type="password" class="rg_password"/></p>
            <p>确认密码：<input type="password" class="rg_confirm_password"/></p>
            <p>姓名：<input type="text" class="rg_name"/>
            <p>手机号：<input type="text" class="rg_phone"/></p>
